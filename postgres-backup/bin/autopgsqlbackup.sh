...
MAILADDR="fabrice.gaillard@ebrains.eu"
...
#=====================================================================
#=====================================================================
PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/snap/bin:/usr/lib/postgresql/9.5/bin
...
OPT="--no-owner"						# OPT string for use with mysqldump ( see man mysqldump )
...
#
# pass user/password as env variables ( https://stackoverflow.com/questions/2893954/how-to-pass-in-password-to-pg-dump )
#

dbdump () {
PGPASSWORD="${DBPASS}" pg_dump --username="${DBUSER}" $HOST $OPT $1 > $2
return 0
}
